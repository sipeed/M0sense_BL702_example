#ifndef _UF2_FORMAT_H_
#define _UF2_FORMAT_H_
...
#define M0SENSE_FAMILY_ID 0x11de784a
...
#define UF2_IS_UF2_BLOCK(blk)                                                                  \
    ({                                                                                         \
        ((blk)->magic_start0 == UF2_MAGIC_START0 && (blk)->magic_start1 == UF2_MAGIC_START1 && \
